...
(() => {
    ...
    type Libro = {titulo: string;autor: string;editorial: string;anioedicion: number}
    
    let LordOfTheRings: Libro ={
        titulo: "Lord of the Rings",
        autor: "JRR. Tolkien",
        editorial: "George Allen & Unwin HarperCollins",
        anioedicion:29061954,
    }
    let LasCronicasDeNarnia: Libro ={
    ...
    class navios implements Barco{
        
        constructor(public nombre:string, public numeroSerie:number, public tipo:string) {
            this.nombre = nombre;
            this.tipo = tipo;
    ...
    let fragata = new navios("Santa María",101,"Fragata");
